document.addEventListener('DOMContentLoaded', function () {
  ...
  if (animatableElements.length > 0) {
    ...
    function applyInitialStyles(el) {
      ...
      if (el.classList.contains('fade-up') || animationType === 'fade-up') {
        el.style.transform = 'translateY(40px)';
      } else if (el.classList.contains('fade-down') || animationType === 'fade-down') {
        el.style.transform = 'translateY(-40px)';
      } else if (el.classList.contains('fade-left') || animationType === 'fade-left') {
        el.style.transform = 'translateX(40px)';
      } else if (el.classList.contains('fade-right') || animationType === 'fade-right') {
        el.style.transform = 'translateX(-40px)';
      } else if (el.classList.contains('slide-in') || animationType === 'slide-in') {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Color Wave משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1048dd35-6bef-4e53-9a3f-7f52ae4cf424',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1048dd35-6bef-4e53-9a3f-7f52ae4cf424';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1048dd35-6bef-4e53-9a3f-7f52ae4cf424';
